...
/* reset scene extents */
void viewer_reset_extents (double *extents);

/* update scene extents */
void viewer_update_extents (double *extents);

/* get minimal view extent */
double viewer_minimal_extent ();
...
void viewer_print (double x, double y, double z, int font, char *fmt, ...);
...
void viewer_trackball_center (double *point);
